...
def HTMLHeader(FILE):
	FILE.write("<HTML><HEAD>Hot 100 Pages</HEAD>")
	FILE.write("<TITLE>100 most newly viewed WP pages</TITLE>\n")
...
HTMLFILE=HTMLDIR+"/hot100_"+str(YEAR)+"_"+str(MONTH)+"_"+str(DAY)+".html"
...
HOTRESULT=db.tmpHot.find().sort('delta',-1).limit(100)
PLACECT=1
OFILE.write('<table>')
